...
for root, dirs, files in os.walk('./data/12_25', topdown=False):
    for name in files:
...
for file in all_file:
    ...
    for j in range(max_length):
        ...
        # all_show.append(robot_status['jointAngle'])
...
# plt.figure(1)
# plt.hist(np.array(all_show)[:, 3], bins=256, facecolor="blue", edgecolor="black", alpha=0.7)
# plt.xlabel("x")
# plt.ylabel("dis")
# plt.show()
# -20, 10
